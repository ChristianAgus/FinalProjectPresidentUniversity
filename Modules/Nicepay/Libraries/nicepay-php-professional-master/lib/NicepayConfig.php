...
define('NICEPAY_IMID', 'HALDINF00D');                                                  // Merchant ID
define('NICEPAY_MERCHANT_KEY', 'DuXlxlO1UAmWVYTJV3/XtHDiFRF4Ah+9U3eIP9TwivCOYoZ82Js5+ph56+3m+Xq+fiQdrCmqBlE5v2XPhrvjhQ=='); // API Key

define('NICEPAY_CALLBACK_URL', 'https://apps.haldinfoods.com/nicepay/frontend/nicepay-v1/db-call-back-url');                       // Merchant's result page URL
define('NICEPAY_DBPROCESS_URL', 'https://apps.haldinfoods.com/nicepay/frontend/nicepay-v1/db-process-url');          // Merchant's notification handler URL
