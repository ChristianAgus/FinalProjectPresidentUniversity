        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="shoping__cart__btns">
                    <a href="{{ route('frontendadmin.home') }}" class="primary-btn cart-btn cart-btn-right">CONTINUE SHOPPING</a>
            ...
            <div class="col-lg-6">
                <div class="shoping__checkout">
                    ...
                    <a href="{{ route('frontendadmin.get_order') }}" class="primary-btn">PROCEED TO CHECKOUT</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    proQty.on('click', '.qtybtn', function () {
        ...
        $.ajax({
            url: "{{ route('frontendadmin.set_cart') }}",
            type: 'POST',
    ...
    $('.shoping__cart__item__close').bind('click', function () {
        ...
        var orderDetailID   = $(this).attr("data-orderDetailID");
        $.ajax({
            url: "{{ route('frontendadmin.remove_cart') }}",
            type: 'POST',
