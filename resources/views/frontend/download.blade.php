...
<style type="text/css">
    ...
    <body>
        <table> 
	        <tr>
	        	<td>
                    ...
                    @endif
                    @if($od_karu > 0)
                    <img src="{{ public_path('/uploads/frontend/talasi.png') }}" alt='Logo Talasi' style="width: 120px; height: 60px" />
                    @endif
                    @if($od_talasi > 0)
                    <img src="{{ public_path('/uploads/frontend/karusotju.png') }}" alt='Logo Karusotju' style="width: 60px; height: 60px" />
                    @endif
                </td>
	        </tr>
        </table>
        ...
        <table width="100%">
            <tr>
                <th class="text-center">Haldin Group appreciate your business,</th>
